...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Boost your self-growth receiving funds every month coming from OMSIAP'S market profit, its marketing fees to businesses that was considered taxation power by OMSIAP, infrastructure projects commissions, web development commissions and community projects profits.",
