...
const UserAccount = (props) => {
  ...
  useEffect(() => {
    ...
    const filtered = allTransactions.filter((transaction) => {
      ...
      const cleanDateStr = transaction.date
  ...
  const confirmDeleteTransactions = async () => {
    try {
      ...
      const response = await axiosCreatedInstance.post("/omsiap/transactions/delete", {
        ...
        userId: props.user._id, // Make sure to pass the user ID
      })

      if (response.data.success) {
        // Update local state with remaining transactions
      ...
      if (error.response) {
        ...
        // If some transactions were deleted but not all
        if (error.response.data?.details?.deleted > 0) {
          ...
          // Refresh transactions to show current state
                ...
                <div className="transaction-modal__total-section">
                  ...
                  <div className="transaction-modal__total-row">
                    ...
                    <span className="transaction-modal__total-amount">
                      ₱
                      {(
                        transaction.merchandisesubtotal +
            ...
            {showGiveawayDetails && transaction.giveawayApiData && (
              <div className="transaction-modal__giveaway-section slide-down">
                <div className="transaction-modal__giveaway-header">
                  ...
                  <div
                    className={`transaction-modal__giveaway-badge ${giveawayDetails.isNegativeDistribution ? "warning" : "success"}`}
                  >
                ...
                <div className="transaction-modal__giveaway-content">
                  {/* Status Message */}
                  <div
                    className={`transaction-modal__status-message ${giveawayDetails.isNegativeDistribution ? "warning" : "success"}`}
                  >
                  ...
                  <div className="transaction-modal__giveaway-summary">
                    <div className="transaction-modal__giveaway-card primary">
                      ...
                      <div className="transaction-modal__giveaway-info">
                        ...
                        <span className="transaction-modal__giveaway-amount">
                          ₱{giveawayDetails.registrantShare.toFixed(2)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="transaction-modal__giveaway-card secondary">
                      ...
                      <div className="transaction-modal__giveaway-info">
                        ...
                        <span className="transaction-modal__giveaway-amount">
                          ₱{giveawayDetails.communityShare.toFixed(2)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="transaction-modal__giveaway-breakdown">
                    <div className="transaction-modal__breakdown-row">
                      ...
                      <span className="transaction-modal__breakdown-value">
                        ₱{giveawayDetails.totalAmount.toFixed(2)}
                      </span>
                    </div>
                    <div className="transaction-modal__breakdown-row">
                      <span className="transaction-modal__breakdown-label">Eligible Users Found:</span>
                      <span className="transaction-modal__breakdown-value">
                        {giveawayDetails.totalEligibleUsers} users
                      </span>
                    </div>
                    ...
                    {!giveawayDetails.isNegativeDistribution ? (
                      <>
                        ...
                        <div className="transaction-modal__breakdown-row">
                          ...
                          <span className="transaction-modal__breakdown-value">
                            ₱{giveawayDetails.perUserShare.toFixed(2)}
                          </span>
                        </div>
                      </>
                    ) : (
                      <div className="transaction-modal__breakdown-row warning">
                        ...
                        <span className="transaction-modal__breakdown-value">
                          ₱{Math.abs(giveawayDetails.pendingFunds).toFixed(2)}
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="transaction-modal__distribution-status">
                    {!giveawayDetails.isNegativeDistribution ? (
                      <div className="transaction-modal__status-indicator success">
                        ...
                        <span>
                          Successfully distributed ₱{giveawayDetails.perUserShare.toFixed(2)} to{" "}
                          {giveawayDetails.totalUsers} users
                        </span>
                      </div>
                    ) : (
            ...
            <div className="transaction-modal__receipt-section">
              ...
              <div className="transaction-modal__receipt-container">
                ...
                transaction.transactionDetails.gcashtransactionreceipt !== "" ? (
                  <>
                    <img
                      src={transaction.transactionDetails.gcashtransactionreceipt || "/placeholder.svg"}
  ...
  const handleRemoveDocument = (documentField) => {
    ...
    // Also add to removedDocuments state to signal backend
    setRemovedDocuments((prev) => [...prev, documentField])
  }
  ...
  const handleOmsiapawasTransferSubmit = async (e) => {
    ...
    if (!omsiapawasTransferForm.recipientId || !omsiapawasTransferForm.amount || !omsiapawasTransferForm.password) {
      ...
      document.getElementById("omsiapawas-transfer-response-message").className =
        "userdashboard-transfer-response-message visible error"
      setOmsiapawasTransferResponseVisible(true)
      return
    }

    if (Number.parseFloat(omsiapawasTransferForm.amount) > props.user.credits.omsiapawas.amount) {
      document.getElementById("omsiapawas-transfer-response-message").innerHTML =
        "Transfer amount cannot exceed your current balance."
      document.getElementById("omsiapawas-transfer-response-message").className =
        "userdashboard-transfer-response-message visible error"
      setOmsiapawasTransferResponseVisible(true)
      return
    ...
    if (Number.parseFloat(omsiapawasTransferForm.amount) < 1) {
      document.getElementById("omsiapawas-transfer-response-message").innerHTML =
    ...
    try {
      ...
      const response = await fetch("/api/transfer-omsiapawas", {
        ...
        body: JSON.stringify({
          ...
          amount: Number.parseFloat(omsiapawasTransferForm.amount),
      ...
      if (response.ok) {
        ...
        document.getElementById("omsiapawas-transfer-response-message").className =
          "userdashboard-transfer-response-message visible success"
              ...
              {props.user.registrationstatusesandlogs.indication === "Verified" ? (
                ...
                <div className="userdashboard-documents-status-grid">
                  ...
                  >
                    ...
                    <div className="userdashboard-document-info">
                      ...
                      >
                        {props.user.personaldata?.birthcertificate?.frontphoto?.image &&
                        props.user.personaldata?.birthCertificateBack?.backphoto?.image
                          ? "Verified"
                          : "Pending Documents"}
                      </span>
                      {!(
                ...
                <div className="userdashboard-verification-message userdashboard-unverified">
                  ...
                  <div className="userdashboard-verification-content">
                    ...
                    <p>
                      Please provide the required documents to verify your account. Upload your birth certificate and
                      government ID in the Settings section.
                    </p>
                    <button className="userdashboard-verification-action-btn">Go to Settings</button>
                  </div>
                </div>
              )}
            </section>
          ...
          <div className="userdashboard-exchange-panel">
            ...
            {props.user?.registrationstatusesandlogs?.deviceloginstatus !== "logged in" ? (
              <div className="userdashboard-login-required-message">
                ...
                >
                  <h4 style={{ color: "#d63384", marginBottom: "10px" }}>🚫 Cash In Not Available</h4>
              ...
              <>
                  ...
                  <div className="userdashboard-notice-content">
                    <ul className="exchange-info">
                      ...
                      <li className="min-amount slide-in">
                        ...
                        Minimum cash in amount is <strong>210 PHP</strong> equivalent to <strong>200 peso's</strong> per
                        transaction.
                      </li>
                      <li className="max-amount slide-in">
                        <FaInfoCircle className="icon" />
                        Maximum cash in amount is <strong>5,250 PHP</strong> equivalent to <strong>5,000 peso's</strong>{" "}
                        per transaction.
                      </li>
                      <li className="process-info bounce-in">
                        <FaMoneyBillWave className="icon" />
                        All cash in transactions are processed through GCash payment integration and will be validated
                        by OMSIAP personnel through the OMSIAP database management system.
                      </li>
                      <li style={{ color: "green" }} className="important-notice pulse">
                        <FaExclamationTriangle className="icon warning" />
                        Failure to send the exact amounts specified in the cash in form will result in your money being
                        returned to your GCash account with a 50-peso deduction for processing, or disciplinary action
                        for not following instructions.
                      </li>
                      <li style={{ color: "white" }} className="receipt-info fade-in">
                        <FaReceipt className="icon" />
                        All cash in transactions require a valid GCash receipt screenshot for validation and comparison
                        by OMSIAP personnel.
                      </li>
                ...
                <section className="userdashboard-exchange-form-section">
                  ...
                  <form className="userdashboard-exchange-form">
                    ...
                    <p style={{ color: "black" }}>
                      1. Copy and paste the reference number in your GCash transaction receipt and paste it in the GCash
                      reference number field below
                    </p>
                    <p style={{ color: "black" }}>2. Take a screenshot of your GCash transaction and upload it here</p>
                    <p style={{ color: "black" }}>
                      3. The process cash in button will be available after selecting an amount in the cash in form.
                      Click process cash in after following procedures 1 and 2. The process cash in button will not be
                      submitted if procedures 1 and 2 are not followed.
                    </p>
                    ...
                    {currencyexchangeloadingindication ? (
                      ...
                      <button
                        ...
                        disabled={
                          !exchangeForm.phpAmount || exchangeForm.phpAmount < 210 || exchangeForm.phpAmount > 5250
                        }
          ...
          <div className="userdashboard-withdrawal-panel">
            ...
            {props.user?.registrationstatusesandlogs?.deviceloginstatus !== "logged in" ? (
              <div className="userdashboard-login-required-message">
                ...
                >
                  <h4 style={{ color: "#d63384", marginBottom: "10px" }}>🚫 Cash Out Not Available</h4>
                  <p style={{ marginBottom: "5px" }}>
                      ...
                      {withdrawalForm.amount && (
                        <div className="userdashboard-fee-breakdown">
                          <div className="userdashboard-fee-item">
                            ...
                            <span>₱{Number.parseFloat(withdrawalForm.amount || 0)}</span>
                          </div>
                          <div className="userdashboard-fee-item">
                            <span>Processing Fee (2.5%):</span>
                            <span>
                              -₱{Math.round(Number.parseFloat(withdrawalForm.amount || 0) * 0.025 * 100) / 100}
                            </span>
                          </div>
                          <div className="userdashboard-fee-item userdashboard-total">
                            <span>
                              <strong>Amount You'll Receive:</strong>
                            </span>
                            <span>
                              <strong>
                                ₱{Math.round(Number.parseFloat(withdrawalForm.amount || 0) * 0.975 * 100) / 100}
                              </strong>
                            </span>
                          </div>
                        </div>
              ...
              <form className="userdashboard-omsiapawastransfer-form" onSubmit={handleOmsiapawasTransferSubmit}>
                ...
                <div className="userdashboard-transfer-summary">
                  ...
                  <div className="userdashboard-summary-row">
                    ...
                    <span className="userdashboard-summary-value">
                      {(
                        props.user.credits.omsiapawas.amount - (Number.parseFloat(omsiapawasTransferForm.amount) || 0)
                      ).toFixed(2)}{" "}
                      OMSIAPAWAS
                    </span>
                  </div>
                ...
                <div className="userdashboard-transfer-actions">
                  {omsiapawasTransferLoadingIndication ? (
                    ...
                    <button
                      ...
                      disabled={
                        !omsiapawasTransferForm.amount ||
                        !omsiapawasTransferForm.recipientId ||
                        !omsiapawasTransferForm.password
                      }
                    >
                      Transfer OMSIAPAWAS
                    </button>
            ...
            <section className="userdashboard-transactions-section">
              ...
              {showDeleteMode && (
                <div className="userdashboard-delete-controls">
                  ...
                  <button
                    className="userdashboard-delete-all-permanent-btn"
                          ...
                          <div className="userdashboard-image-preview">
                            {profileForm.birthCertificateFront ? (
                              <div className="userdashboard-document-preview">
                                <img
                                  src={
                                    typeof profileForm.birthCertificateFront === "string"
                                      ? profileForm.birthCertificateFront
                          ...
                          <div className="userdashboard-image-preview">
                            {profileForm.birthCertificateBack ? (
                              <div className="userdashboard-document-preview">
                                <img
                                  src={
                                    typeof profileForm.birthCertificateBack === "string"
                                      ? profileForm.birthCertificateBack
                          ...
                          <div className="userdashboard-image-preview">
                            {profileForm.governmentIdFront ? (
                              <div className="userdashboard-document-preview">
                                <img
                                  src={
                                    typeof profileForm.governmentIdFront === "string"
                                      ? profileForm.governmentIdFront
                          ...
                          <div className="userdashboard-image-preview">
                            {profileForm.governmentIdBack ? (
                              <div className="userdashboard-document-preview">
                                <img
                                  src={
                                    typeof profileForm.governmentIdBack === "string"
                                      ? profileForm.governmentIdBack
